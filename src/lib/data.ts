...
export const IA_IEF: Record<string, string[]> = {
  ...
  Thiès: ["Thiès Ville", "Thiès Département", "Tivaouane"],
  "Saint-Louis": ["Saint-Louis Commune", "Saint-Louis Département", "Dagana"],
  Diourbel: ["Diourbel", "Bambey", "Mbacké"],
  Fatick: ["Fatick", "Foundiougne", "Gossas"],
  Kaolack: ["Kaolack", "Nioro", "Guinguinéo"],
  ...
  "Pikine-Guédiawaye": ["Keur Massar", "Pikine", "Guédiawaye", "Thiaroye"],
